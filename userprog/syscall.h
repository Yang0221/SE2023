...
/* put a character in the consoledriver which corresponds to the one passed in parameter  .*/
void PutChar(char c);

/* put a String in the consoledriver which corresponds to the one passed in parameter . */
void PutString(char *s);


/* Get  a char from  consoledriver . */
int GetChar();

/* Get  a string from consoledriver . */
char* GetString(char *s, int n);

/*Put  an int from  consoledriver*/
void PutInt(int n);
